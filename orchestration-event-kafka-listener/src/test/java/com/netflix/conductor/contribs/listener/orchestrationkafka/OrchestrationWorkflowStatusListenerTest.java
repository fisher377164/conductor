...
class OrchestrationWorkflowStatusListenerTest {

    private final ObjectMapper objectMapper = new ObjectMapper();
    private MockProducer<String, String> mockProducer;
    private OrchestrationWorkflowStatusListener listener;
    ...
    void setUp() {
        ...
        listener =
                new OrchestrationWorkflowStatusListener(
                        properties,
    ...
    void routesEventToPerEventTopicOverride() throws Exception {
        ...
        OrchestrationWorkflowStatusListener overriddenListener =
                new OrchestrationWorkflowStatusListener(
                        properties,
                        new OrchestrationEventKafkaPublisher(objectMapper, mockProducer));
    ...
    void usesKafkaProducerManagerAsProducerSource() {
        ...
        OrchestrationWorkflowStatusListener managedListener =
                new OrchestrationWorkflowStatusListener(
    ...
    void skipsEventsNotInSubscribedList() {
        ...
        OrchestrationWorkflowStatusListener completedOnlyListener =
                new OrchestrationWorkflowStatusListener(
                        properties,
                        new OrchestrationEventKafkaPublisher(objectMapper, mockProducer));
